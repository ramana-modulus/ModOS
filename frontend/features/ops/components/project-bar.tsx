...
interface ProjectBarProps {
  ...
  onChange: (scope: { project: string; subProject: string }) => void;
}

/** Project pill row + meta + sub-project pill row (faithful to renderOps). */
export function ProjectBar({ projects, project, scope, onChange }: ProjectBarProps) {
    ...
    <>
      ...
      <div className="mb-1.5 flex items-center justify-between">
        ...
        <div className="text-t10 text-faint">
          {project.code} · {project.client} · Day 53 of {project.duration}
        </div>
      </div>
